...
Кнопка джойстика `SW` подключается между GPIO и GND. Включен внутренний
pull-up.

Сейчас управление такое:

- VRX влево/вправо - ходьба
- VRY вверх - прыжок
- SW - копать блок
- установка блока пока не назначена, потому что у джойстика только одна кнопка
